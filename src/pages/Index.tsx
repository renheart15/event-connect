          ...
          <div className="mb-8">
            <Card className="max-w-md mx-auto">
              <CardHeader>
                ...
                <CardDescription className="text-sm">Select how you'll be using EventConnect</CardDescription>
              </CardHeader>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="text-center">
              <CardContent className="pt-6">
                ...
                <h4 className="text-lg font-semibold mb-2">QR Code Check-in</h4>
            ...
            <Card className="text-center">
              <CardContent className="pt-6">
                ...
                <h4 className="text-lg font-semibold mb-2">GPS Verification</h4>
            ...
            <Card className="text-center">
              <CardContent className="pt-6">
                ...
                <h4 className="text-lg font-semibold mb-2">Live Dashboard</h4>
