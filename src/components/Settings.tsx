            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => handleSetting('privacy.profileVisible', checked)}
                />
              </div>
              <div className="flex items-center justify-between">
                <div>
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => handleSetting('privacy.shareAnalytics', checked)}
                />
              </div>
            </CardContent>
          </Card>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Select 
                    ...
                    onValueChange={(value) => handleSetting('preferences.timezone', value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div>
                  ...
                  <Select 
                    ...
                    onValueChange={(value) => handleSetting('preferences.dateFormat', value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
